...
if (isset($_COOKIE['asikzade_user_session'])) {
    // İsteğe bağlı: Cookie'yi burada decode edip ek bir doğrulama yapabilirsiniz.
...
<head>
    ...
    <style>
        :root {
            ...
            --login-button-bg: #7fb3ec; /* Bu renk temanızla uyumlu mu kontrol edin */
            --login-button-text: #000000;
            --login-button-hover-bg: #6aa3e0; /* Bu renk temanızla uyumlu mu kontrol edin */
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-form-container { width: 100%; max-width: 550px; padding: 20px; text-align: center; background-color: var(--asikzade-light-text); border-radius: 10px; box-shadow: 0 5px 20px rgba(0,0,0,0.08); }
        .login-form-container h1 { font-size: 36px; margin-bottom: 30px; color: var(--asikzade-dark-text); font-weight: 600; }
        .message-box { padding: 15px; margin-bottom: 20px; border: 1px solid transparent; border-radius: .25rem; font-size: 14px; text-align: left;}
        ...
        .login-btn { background-color: var(--asikzade-green); color: var(--asikzade-light-text); border: none; width: 100%; padding: 15px; border-radius: 50px; font-size: 16px; font-weight: 500; cursor: pointer; margin-top: 15px; transition: background-color 0.3s ease, transform 0.2s ease; text-transform: none; letter-spacing: normal; }
        .login-btn:hover { background-color: var(--asikzade-dark-green); transform: translateY(-2px); }
        ...
        @media (max-width: 768px) {
            ...
            .login-page-wrapper { padding-top: 100px; padding-bottom: 60px; } .login-form-container { max-width: 90%; margin-left: auto; margin-right: auto; } .login-form-container h1 { font-size: 30px; margin-bottom: 30px; }
        ...
        @media (max-width: 480px) {
            ...
            .login-page-wrapper { padding-top: 90px; padding-bottom: 40px; } .login-form-container { max-width: 95%; } .login-form-container h1 { font-size: 26px; } .input-group input { padding: 11px 14px; font-size: 13px;} .login-btn { padding: 14px; font-size: 15px;}
        }
    </style>
</head>
<body>
    <header class="header" id="mainHeader">
        <a href="/index.php" class="logo-container"> <!-- KÖK DİZİNE GÖNDER -->
            <img src="https://i.imgur.com/rdZuONP.png" alt="Aşıkzade Logo" id="headerLogoImage">
            <span class="logo-text" id="siteLogoTextMawa">AŞIKZADE</span> <!-- Logo metnini ekledim -->
        </a>
        <nav class="main-nav">
            <div class="user-actions-group">
                <a href="/login.php" class="nav-user-icon" aria-label="Kullanıcı Girişi"> <!-- KÖK DİZİNE GÖNDER -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                        <circle cx="12" cy="7" r="4"></circle>
                    </svg>
                </a>
                <a href="/sepet.php" class="nav-cart-icon" aria-label="Sepetim"> <!-- KÖK DİZİNE GÖNDER -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <main class="login-page-wrapper">
        <div class="login-form-container">
            ...
            <form action="/login_process.php" method="POST" class="login-form"> <!-- KÖK DİZİNDE OLDUĞUNU VARSAYIYORUM -->
                ...
                <div class="input-group">
                    ...
                    <!-- <a href="/forgot_password.php" class="forgot-password">Şifrenizi mi unuttunuz?</a> --> <!-- Bu dosya varsa / ile ekleyin -->
                </div>
                
                <button type="submit" class="login-btn">Giriş Yap</button>
            </form>
            <p class="signup-link">
                Hesabınız yok mu? <a href="/register.php">Hemen Kaydolun</a> <!-- KÖK DİZİNDE OLDUĞUNU VARSAYIYORUM -->
            </p>
        </div>
    </main>
